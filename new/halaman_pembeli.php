        ...
        <div class="layout-page">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo $tampil['image_url']; ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">OKEBUS /</span> PRESENT</h4>
                  ...
                  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="images/sinar_jaya.jpg" alt="First slide" />
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="images/dewi_sri.jpeg" alt="Second slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>Dewi Sri</h3>
